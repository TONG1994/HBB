...
import DrawerModal from './components/VersionModal';
...
const FormDef = require('./components/VersionForm');
    ...
    render() {
        ...
        let operCol = {
            ...
            render: (text, record) => {
                return (
                    <span>
              <a onClick={()=>this.onClickUserCode(record)} title='修改' >修改</a>
            </span>
                )
            }
        };
            ...
            <div className="grid-page">
              <DrawerModal {...drawerModalProps} />
                <div key='1' className='table-box'>
                  <Filter ref={ref => this.Filter = ref} onCreate={this.onClickUserCode}/>
                  <DictTable
